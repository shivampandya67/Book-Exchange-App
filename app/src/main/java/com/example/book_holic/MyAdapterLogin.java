...
public class MyAdapterLogin extends RecyclerView.Adapter<MyAdapterLogin.MyViewHolder> implements Filterable {
    ...
    public MyAdapterLogin(ArrayList<bookdata> list,Context context) {
